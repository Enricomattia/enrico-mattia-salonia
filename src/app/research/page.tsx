      ...
      <PageSection>
        ...
        >
          <Abstract
            ...
            availability="Submitted, draft available upon request"
          />
        </CardExtended>
